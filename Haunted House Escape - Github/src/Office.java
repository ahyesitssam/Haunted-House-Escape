 ...
 * Last Update: 4/20
 * 
 * Serves as the Office of the house.
 * It includes the entrance to the crawlspace, allowing the user to exit the
 * house
...
public class Office extends Room {
    ...
    /**
     * Constructor. Initializes the Office room.
     * 
    ...
    /**
     * Prints information, and handles interaction based on
     * whether or not user already has crowbar to enter.
     */
    @Override
    ...
    /**
     * Handles print statements and calls CrawlSpace when the user has the crowbar.
     */
